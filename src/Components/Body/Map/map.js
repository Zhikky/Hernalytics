...
function Map(props) {
  ...
  const handlePathHover = (event) => {
    const content1 = event.target.getAttribute("data-vote");
    const content2 = event.target.getAttribute("data-party");
    setHoverVotes(content1);
    setHoverParty(content2);
    setIsHovered(true);
  };
  ...
  return (
    <div className="map" onMouseMove={handleMouseMove}>
      ...
      >
        <path
          title="This is some information about Section 1"
        ...
        <path
          ...
          onMouseOver={handlePathHover}
          data-vote={props.data?.Abia?.[0]?.candidate_votes}
          data-party={props.data?.Abia?.[0]?.political_party_name}
        ></path>
        <path
        ...
        <path
          ...
          onMouseLeave={() => setIsHovered(false)}
          onMouseOver={handlePathHover}
          data-vote={props.data?.Rivers?.[0]?.candidate_votes}
          data-party={props.data?.Rivers?.[0]?.political_party_name}
        ></path>
        <path
        ...
        <path
          ...
          onMouseLeave={() => setIsHovered(false)}
          onMouseOver={handlePathHover}
          data-vote={props.data?.Cross_Rivers?.[0]?.candidate_votes}
          data-party={props.data?.Cross_Rivers?.[0]?.political_party_name}
        ></path>
        <path
        ...
        <path
          ...
          onMouseLeave={() => setIsHovered(false)}
          onMouseOver={handlePathHover}
          data-vote={props.data?.Lagos?.[0]?.candidate_votes}
          data-party={props.data?.Lagos?.[0]?.political_party_name}
        ></path>
        <path
        ...
        <path
          ...
          onMouseLeave={() => setIsHovered(false)}
          onMouseOver={handlePathHover}
          data-vote={props.data?.Anambra?.[0]?.candidate_votes}
          data-party={props.data?.Anambra?.[0]?.political_party_name}
        ></path>
        <path
        ...
        <path
          ...
          onMouseLeave={() => setIsHovered(false)}
          onMouseOver={handlePathHover}
          data-vote={props.data?.Sokoto?.[0]?.candidate_votes}
          data-party={props.data?.Sokoto?.[0]?.political_party_name}
        ></path>
        <path
        ...
        <path
          ...
          onMouseLeave={() => setIsHovered(false)}
          onMouseOver={handlePathHover}
          data-vote={props.data?.Adamawa?.[0]?.candidate_votes}
          data-party={props.data?.Adamawa?.[0]?.political_party_name}
        ></path>
        <path
